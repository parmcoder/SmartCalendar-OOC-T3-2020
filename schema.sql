...
insert into APP_ROLE(ROLE_ID, ROLE_NAME) values (1,'ROLE_ADMIN'),(2,'ROLE_USER');

insert into APP_USER(USER_ID, USER_NAME, ENCRYPTED_PASSWORD, ENABLED, USER_REAL_NAME, USER_REAL_SURNAME) values
(1, 'adminparm', '$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu', 1, 'Parm', 'yaboi');
--pass 123
